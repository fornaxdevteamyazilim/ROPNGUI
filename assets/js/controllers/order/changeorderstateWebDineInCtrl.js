app.controller('changeorderstateWebDineInCtrl', changeorderstateWebDineInCtrl);
function changeorderstateWebDineInCtrl($rootScope, $scope, $modalInstance, item, Restangular, toaster, $window, $translate, $filter) {
    $rootScope.uService.EnterController("changeorderstateWebDineInCtrl");
    ...
    $scope.$on('$destroy', function () {
        deregistration();
        $scope.LoadOrder();
        $rootScope.uService.ExitController("changeorderstateWebDineInCtrl");
    });
};
