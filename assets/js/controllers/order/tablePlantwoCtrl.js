app.controller('tablePlantwoCtrl', tablePlantwoCtrl);
function tablePlantwoCtrl($scope, $log, $modal, Restangular, $filter, SweetAlert, ngTableParams, toaster, $window, $rootScope, $location, $translate, userService, $element) {
    $rootScope.uService.EnterController("tablePlantwoCtrl");
    ...
    $scope.translate = function () {
        ...
        $scope.TABLEPLANTXT = $translate.instant('main.TABLEPLAN');
    ...
    $scope.$on('$destroy', function () {
        tranlatelistener();
        $element.remove();
        $rootScope.uService.ExitController("tablePlantwoCtrl");
    });
};
