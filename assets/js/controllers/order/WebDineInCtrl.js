...
app.controller('WebDineInCtrl', WebDineInCtrl);
function WebDineInCtrl($scope, $log, $modal, Restangular, $filter, SweetAlert, ngTableParams, toaster, $window, $rootScope, $location, $translate, userService, $element) {
    $rootScope.uService.EnterController("WebDineInCtrl");
    ...
    $scope.SaveOpenOrders = function (data) {
        swal({
            title: $translate.instant('orderfile.Markorderasdelivered'),
            type: "warning",
