...
function StreetAddressSelectorCtrl($scope, $rootScope, $modalInstance, $location, StreetAddressID,InfoNotes, $log, $filter, SweetAlert, Restangular, ngTableParams, toaster, $window, $translate, userService) {
    $rootScope.uService.EnterController("StreetAddressSelectorCtrl");
    ...
    $scope.$on('$destroy', function () {
        deregistration();
        deregistration1();
        $rootScope.uService.ExitController("StreetAddressSelectorCtrl");
    });
};
