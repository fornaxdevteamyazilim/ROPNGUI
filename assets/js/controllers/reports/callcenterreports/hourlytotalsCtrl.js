...
function hourlytotalsCtrl($scope, $log, $modal, $filter, SweetAlert, Restangular, $interval, $translate, ngTableParams, toaster, $window, $stateParams, $location, Excel, $timeout, NG_SETTING, ngnotifyService, $rootScope, $element) {
    ...
    $scope.LoadDailyTotals = function (FromValue) {
        ...
        Restangular.all('order/reports/hourlytotals').getList(
            {
                StartDate: $scope.StartDate,
                EndDate: $scope.EndDate,
                OrderSourceID: 103308197377,
            }
    ...
    $scope.DailyTotalsExcel = function () {
        location.href = NG_SETTING.apiServiceBaseUri + '/api/order/reports/hourlytotalsxls?StartDate=' + $scope.StartDate + '&EndDate=' + $scope.EndDate;
    };
    $scope.exportToExcel = function (tableId) {
        ...
        downloadLink.attr('download', 'CM Saatlere Göre Günlük Toplamlar.xls');
