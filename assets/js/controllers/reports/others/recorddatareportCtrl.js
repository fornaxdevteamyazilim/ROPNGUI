app.controller('recorddatareportCtrl', recorddatareportCtrl);
function recorddatareportCtrl($scope, $rootScope, $modal, $filter, SweetAlert, Restangular, toaster, $window, $stateParams, $timeout, $location, $translate, Excel, userService, ngnotifyService, NG_SETTING, $element) {
            $rootScope.uService.EnterController("recorddatareportCtrl");
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('personreports/recorddata').getList(
            {
    ...
    $scope.RecordDataExcel = function () {
        location.href = NG_SETTING.apiServiceBaseUri + '/api/personreports/recorddataxls?StoreID=' + $scope.StoreID + '&StartDate=' + $rootScope.ReportParameters.StartDate + '&EndDate=' + $rootScope.ReportParameters.EndDate;
    };
    $scope.exportToExcel = function (tableId) {
        $scope.exportHref = Excel.tableToExcel(tableId, 'Yeni Kayit Musteriler');
    ...
    $scope.Back = function () {
        ...
        $element.remove();
        $rootScope.uService.ExitController("recorddatareportCtrl");
    });
};
