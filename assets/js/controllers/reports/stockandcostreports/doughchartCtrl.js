...
'use strict';
app.controller('doughchartCtrl', doughchartCtrl);
function doughchartCtrl($scope, $filter, $modal, $log, Restangular, ngTableParams, SweetAlert, $timeout, toaster, $window, $rootScope, $compile, $location, $translate, Excel, ngnotifyService, $element) {
    $rootScope.uService.EnterController("doughchartCtrl");
...
$scope.SetStoreID = function (FromValue) {
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('reports/operational/doughchart').getList(
                {
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("doughchartCtrl");
    });
};
