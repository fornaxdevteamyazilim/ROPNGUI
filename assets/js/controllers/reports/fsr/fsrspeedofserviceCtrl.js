                ...
                columns: [
                    {
                        ...
                        columns: [
                            ...
                            { caption: "U30Count", dataField: "DeliveryU30Count", dataType: "number", format: { type: "fixedPoint", precision: 0 },},
                            { caption: "DeliveryCount", dataField: "DeliveryCount", dataType: "number", format: { type: "fixedPoint", precision: 0 },},
                        ]
                    },
                    {
                        caption: $scope.weekCaption2,
                        ...
                        columns: [
                            ...
                            { caption: "U30Count", dataField: "DeliveryU30Count2", dataType: "number", format: { type: "fixedPoint", precision: 0 } },
                            { caption: "DeliveryCount", dataField: "DeliveryCount2", dataType: "number", format: { type: "fixedPoint", precision: 0 } },
                        ]
                    }],
                fixed: false
            },
