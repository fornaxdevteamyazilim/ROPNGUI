app.controller('scoreCardCtrl', scoreCardCtrl);
function scoreCardCtrl($scope, $rootScope, $modal, $filter, SweetAlert, Restangular, toaster, $window, $stateParams, $timeout, $location, $translate, Excel, userService, ngnotifyService, NG_SETTING, $element) {
    $rootScope.uService.EnterController("scoreCardCtrl");
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('StoreReports/ScoreCard').getList(
            {
    ...
    $scope.exportToExcel = function (tableId) {
        $scope.exportHref = Excel.tableToExcel(tableId, 'ScoreCard');
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("scoreCardCtrl");
    });
};
