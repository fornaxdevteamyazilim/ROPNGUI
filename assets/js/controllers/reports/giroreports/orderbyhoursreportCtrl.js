...
function ordersbyhoursreportCtrl($scope, $filter, $modal, $log, Restangular, ngTableParams, SweetAlert, toaster, $window, $compile, Excel, $timeout, ngnotifyService, $rootScope, $element) {
