app.controller('storerankingCtrl', storerankingCtrl);
function storerankingCtrl($scope, $rootScope, $modal, $filter, SweetAlert, Restangular, toaster, $window, $stateParams, $timeout, $location, $translate, Excel, userService, ngnotifyService, NG_SETTING, $element) {
    $rootScope.uService.EnterController("storerankingCtrl");
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('extendedreports/storeranking').getList(
            {
                ...
                $scope.totalSalesTotal = $scope.sumColumnJS(result, "SalesTotal");
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("storerankingCtrl");
    });
};
