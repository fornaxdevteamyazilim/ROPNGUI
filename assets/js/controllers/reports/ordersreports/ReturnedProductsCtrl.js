...
'use strict';
app.controller('ReturnedProductCtrl', ReturnedProductCtrl);
function ReturnedProductCtrl($scope, $filter, $modal, $log, Restangular, ngTableParams, SweetAlert, toaster, $window, $rootScope, $compile, Excel, $timeout, $location, $translate, userService, ngnotifyService, $element) {
    $rootScope.uService.EnterController("ReturnedProductCtrl");
        if (!$scope.StartDate) {
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('order/demoreports/ReturnedProducts').getList(
                {
                    ...
                    //    result[i].OperationDate = $filter('date')(result[i].OperationDate, 'yyyy-MM-dd');
                    //    $scope.ShowStores = true;
                    //}
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("ReturnedProductCtrl");
    });
};
