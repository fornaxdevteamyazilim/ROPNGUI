'use strict';
app.controller('promotioncodedetailsCtrl', promotioncodedetailsCtrl);
function promotioncodedetailsCtrl($scope, $log, $modal, $filter, SweetAlert, Restangular, $interval, ngTableParams, toaster, $window, $stateParams, $rootScope, $location, $translate, $timeout, ngnotifyService, $element, userService) {
    $rootScope.uService.EnterController("promotioncodedetailsCtrl");
    if (!$scope.StartDate) {
    ...
    $scope.LoadOrderPromotions = function (FromValue) {
        ...
        Restangular.all('PromotionReports/PromotionCodeDetails').getList(
            {
    ...
    //    $scope.exportHref = Excel.tableToExcel(tableId, 'Promosyon Kod Detayları');
    ...
    $scope.exportToExcel = function (tableId) {
        ...
        downloadLink.attr('download', 'Promosyon Kod Detaylari.xls');
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("promotioncodedetailsCtrl");
    });
};
