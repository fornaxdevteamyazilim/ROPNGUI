...
function OrderPaymentsCtrl($scope, $filter, $modal, $log, Restangular, ngTableParams, SweetAlert, toaster, $window, $rootScope, $compile, Excel, $timeout, $location, $translate, userService, ngnotifyService, $element) {
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('order/demoreports/OrderPayments').getList(
                {
    ...
    $scope.exportToExcel = function (tableId) {
        ...
        downloadLink.attr('download', 'OdemeTiplerineGoreSiparisTutarlari.xls');
