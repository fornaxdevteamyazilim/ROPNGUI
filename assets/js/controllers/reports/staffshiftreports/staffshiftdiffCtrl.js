app.controller('staffshiftdiffCtrl', staffshiftdiffCtrl);
function staffshiftdiffCtrl($scope, $rootScope, $modal, $filter, SweetAlert, Restangular, toaster, $window, $stateParams, $timeout, $location, $translate, Excel, userService, ngnotifyService, NG_SETTING, $element) {
    $rootScope.uService.EnterController("staffshiftdiffCtrl");
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('shiftools/Diff').getList(
            {
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("staffshiftdiffCtrl");
    });
};
