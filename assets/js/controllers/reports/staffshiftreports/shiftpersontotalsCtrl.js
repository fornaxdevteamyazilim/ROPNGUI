app.controller('shiftpersontotalsCtrl', shiftpersontotalsCtrl);
function shiftpersontotalsCtrl($scope, $rootScope, $modal, $filter, SweetAlert, Restangular, toaster, $window, $stateParams, $timeout, $location, $translate, Excel, userService, ngnotifyService, NG_SETTING, $element) {
    $rootScope.uService.EnterController("shiftpersontotalsCtrl");
    ...
    $scope.LoadData = function () {
        ...
        Restangular.all('shifttools/GetPersonTotals').getList(
            {
                ...
                //$scope.totalShift = $scope.sumColumnJS(result, "persons.TotaShifts");
                //$scope.totalHours = $scope.sumColumnJS(result, "persons.TotalHours");
    ...
    $scope.exportToExcel = function (tableId) {
        $scope.exportHref = Excel.tableToExcel(tableId, 'PersonelVardiyaToplamlari');
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("shiftpersontotalsCtrl");
    });
};
