app.controller('shiftactualtotalsCtrl', shiftactualtotalsCtrl);
function shiftactualtotalsCtrl($scope, $rootScope, $modal, $filter, SweetAlert, Restangular, toaster, $window, $stateParams, $timeout, $location, $translate, Excel, userService, ngnotifyService, NG_SETTING, $element) {
    $rootScope.uService.EnterController("shiftactualtotalsCtrl");
    ...
    $scope.LoadData = function () {
        ...
        Restangular.one('shiftools/GetActualTotals').get(
            {
    ...
    $scope.exportToExcel = function (tableId) {
        $scope.exportHref = Excel.tableToExcel(tableId, 'GerceklesenVardiyaToplamlari');
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("shiftactualtotalsCtrl");
    });
};
