'use strict';
app.controller('productusagecountsCtrl', productusagecountsCtrl);
function productusagecountsCtrl($scope, $log, $modal, $filter, SweetAlert, Restangular, $interval, ngTableParams, toaster, $window, Excel, $timeout, $stateParams, $rootScope, $location, $translate, ngnotifyService, $element) {
    $rootScope.uService.EnterController("productusagecountsCtrl");
    ...
    $scope.LoadProductUsageCounts = function (FromValue) {
        ...
        Restangular.all('reports/productusagecounts').getList(
            {
    ...
    $scope.Back = function () {
        ...
        $element.remove();
        $rootScope.uService.ExitController("productusagecountsCtrl");
    });
};
