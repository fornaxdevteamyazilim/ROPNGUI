app.controller('kdskfc2Ctrl', kdskfc2Ctrl);
function kdskfc2Ctrl($rootScope, $scope, $log, $modal, $translate, $interval, $timeout, Restangular, ngTableParams, SweetAlert, toaster, $window, $rootScope, $location, $filter, localStorageService, $translate, ngnotifyService, userService, ngAudio, $element, $localStorage) {
    $rootScope.uService.EnterController("kdskfc2Ctrl");
    $scope.item = {};
    ...
    $scope.$on('$destroy', function () {
        ...
        $rootScope.uService.ExitController("kdskfc2Ctrl");
    });
};
