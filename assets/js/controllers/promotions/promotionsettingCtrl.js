app.controller('promotionsettingCtrl', promotionsettingCtrl);
function promotionsettingCtrl($rootScope, $scope, $modal, $filter, SweetAlert, Restangular, ngTableParams, toaster, $window, $stateParams, $location, $translate, $element) {
    $rootScope.uService.EnterController("promotionsettingCtrl");
    var ps = this;
    ...
    ps.tableParams = new ngTableParams({
        ...
        getData: function ($defer, params) {
            Restangular.all('PromotionSetting').getList({
                pageNo: params.page(),
    ...
    $scope.saveData = function (data) {
        if (data.restangularized && data.id) {
            ...
            Restangular.restangularizeElement('', data, 'PromotionSetting')
    ...
    $scope.$on('$destroy', function () {
        deregistration();
        $element.remove();
        $rootScope.uService.ExitController("promotionsettingCtrl");
    });
};
