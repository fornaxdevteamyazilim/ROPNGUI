app.controller('automaticOrderItemEarningCtrl', automaticOrderItemEarningCtrl);
function automaticOrderItemEarningCtrl($rootScope, $scope, $modal, $filter, SweetAlert, Restangular, ngTableParams, toaster, $window, $stateParams, $location, $translate, $element) {
    $rootScope.uService.EnterController("automaticOrderItemEarningCtrl");
    var per = this;
    $scope.translate = function () {
        ...
        $scope.trMinOrderAmount = $translate.instant('main.MINAMOUNT');
    ...
    per.tableParams = new ngTableParams({
        ...
        getData: function ($defer, params) {
            Restangular.all('AutomaticOrderItemEarningRule').getList({
                pageNo: params.page(),
    ...
    $scope.saveData = function (data) {
        if (data.restangularized && data.id) {
            ...
            Restangular.restangularizeElement('', data, 'AutomaticOrderItemEarningRule')
    ...
    $scope.AutomaticOrderItemSetting = [];
    $scope.loadEntities('AutomaticOrderItemSetting', 'AutomaticOrderItemSetting');
    $scope.promotions = [];
    ...
    $scope.$on('$destroy', function () {
        deregistration();
        $element.remove();
        $rootScope.uService.ExitController("automaticOrderItemEarningCtrl");
    });
};
