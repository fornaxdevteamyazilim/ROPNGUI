app.controller('getirstatsCtrl', getirstatsCtrl);
function getirstatsCtrl($rootScope, $scope, $log, $modal, $interval, Restangular, ngTableParams, $timeout, SweetAlert, toaster, $window, $location, $translate, $element, userService) {
    $rootScope.uService.EnterController("getirstatsCtrl");
    ...
    $scope.$on('$destroy', function () {
        ...
        $element.remove();
        $rootScope.uService.ExitController("getirstatsCtrl");
    });
};
