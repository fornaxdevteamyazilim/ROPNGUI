app.controller('newpersonCtrl', newpersonCtrl);
function newpersonCtrl($scope, Restangular, item, $modal, ngTableParams, toaster, $window, $rootScope, $location, $translate, $modalInstance, userService, $filter, ngnotifyService) {
    $rootScope.uService.EnterController("newpersonCtrl");
    $scope.item = {};
    $scope.original = {};
    $scope.personitem = {};
    $scope.MerketingData = {};
    ...
    $scope.$on('$destroy', function () {
        tranlatelistener();
        $rootScope.uService.ExitController("newpersonCtrl");
    });
};