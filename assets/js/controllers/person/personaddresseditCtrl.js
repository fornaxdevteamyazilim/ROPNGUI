...
function personaddresseditCtrl($scope, $log, $modal, $filter, SweetAlert, Restangular, ngTableParams, toaster, $window,$translate, $rootScope, $stateParams, $location, userService, $element, ngnotifyService) {
    $("#search").focus();
